...
public final class PlaybackStateCompat implements Parcelable {
    ...
    public static final Creator<PlaybackStateCompat> CREATOR = new C01141();
    ...
    static class C01141 implements Creator<PlaybackStateCompat> {
        C01141() {
        }
    ...
    public static final class CustomAction implements Parcelable {
        public static final Creator<CustomAction> CREATOR = new C01151();
        ...
        static class C01151 implements Creator<CustomAction> {
            C01151() {
            }
