...
public class MediaSessionCompat {
    ...
    public static final class QueueItem implements Parcelable {
        public static final Creator<QueueItem> CREATOR = new C01101();
        public static final int UNKNOWN_ID = -1;
        private final MediaDescriptionCompat mDescription;
        private final long mId;
        private Object mItem;

        static class C01101 implements Creator<QueueItem> {
            C01101() {
            }
    ...
    static final class ResultReceiverWrapper implements Parcelable {
        public static final Creator<ResultReceiverWrapper> CREATOR = new C01111();
        private ResultReceiver mResultReceiver;

        static class C01111 implements Creator<ResultReceiverWrapper> {
            C01111() {
            }
    ...
    public static final class Token implements Parcelable {
        public static final Creator<Token> CREATOR = new C01121();
        private final Object mInner;

        static class C01121 implements Creator<Token> {
            C01121() {
            }
    ...
    class C07801 extends Callback {
        C07801() {
        }
    }

    class C07812 extends Callback {
        C07812() {
        }
    }
    ...
    static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        final String mTag;
        private final Token mToken;
        private android.support.v4.media.VolumeProviderCompat.Callback mVolumeCallback = new C07821();
        ...
        class C07821 extends android.support.v4.media.VolumeProviderCompat.Callback {
            C07821() {
            }
        ...
        class C11272 implements Callback {
            C11272() {
            }
