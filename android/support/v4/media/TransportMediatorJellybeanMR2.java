...
class TransportMediatorJellybeanMR2 {
    OnAudioFocusChangeListener mAudioFocusChangeListener = new C01024();
    boolean mAudioFocused;
    final AudioManager mAudioManager;
    final Context mContext;
    boolean mFocused;
    final OnGetPlaybackPositionListener mGetPlaybackPositionListener = new C01035();
    final Intent mIntent;
    final BroadcastReceiver mMediaButtonReceiver = new C01013();
    PendingIntent mPendingIntent;
    int mPlayState = 0;
    final OnPlaybackPositionUpdateListener mPlaybackPositionUpdateListener = new C01046();
    final String mReceiverAction;
    final IntentFilter mReceiverFilter;
    RemoteControlClient mRemoteControl;
    final View mTargetView;
    final TransportMediatorCallback mTransportCallback;
    final OnWindowAttachListener mWindowAttachListener = new C00991();
    final OnWindowFocusChangeListener mWindowFocusListener = new C01002();

    class C00991 implements OnWindowAttachListener {
        C00991() {
        }
    ...
    class C01002 implements OnWindowFocusChangeListener {
        C01002() {
        }
    ...
    class C01013 extends BroadcastReceiver {
        C01013() {
        }
    ...
    class C01024 implements OnAudioFocusChangeListener {
        C01024() {
        }
    ...
    class C01035 implements OnGetPlaybackPositionListener {
        C01035() {
        }
    ...
    class C01046 implements OnPlaybackPositionUpdateListener {
        C01046() {
        }
