...
public class TransportMediator extends TransportController {
    ...
    class C00982 implements Callback {
        C00982() {
        }
    ...
    class C07781 implements TransportMediatorCallback {
        C07781() {
        }
    ...
    private TransportMediator(Activity activity, View view, TransportPerformer callbacks) {
        ...
        this.mTransportKeyCallback = new C07781();
        this.mKeyEventCallback = new C00982();
