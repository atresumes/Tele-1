...
public class ViewDragHelper {
    ...
    private static final Interpolator sInterpolator = new C01581();
    ...
    private final Runnable mSetIdleRunnable = new C01592();
    private int mTouchSlop;
    private int mTrackingEdges;
    private VelocityTracker mVelocityTracker;

    static class C01581 implements Interpolator {
        C01581() {
        }
