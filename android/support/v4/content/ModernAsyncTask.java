...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    private static final ThreadFactory sThreadFactory = new C00661();
    ...
    private final WorkerRunnable<Params, Result> mWorker = new C07702();

    static class C00661 implements ThreadFactory {
    ...
    class C07702 extends WorkerRunnable<Params, Result> {
        C07702() {
        }
