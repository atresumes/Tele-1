...
class NotificationCompatKitKat {
    ...
    public static class Builder implements NotificationBuilderWithBuilderAccessor, NotificationBuilderWithActions {
        private android.app.Notification.Builder f932b;
        ...
        public void addAction(Action action) {
            this.mActionExtrasList.add(NotificationCompatJellybean.writeActionAndGetExtras(this.f932b, action));
        }
        ...
        public Notification build() {
            ...
            this.f932b.setExtras(this.mExtras);
            Notification notification = this.f932b.build();
