...
public class ListFragment extends Fragment {
    ...
    View mListContainer;
    boolean mListShown;
    private final OnItemClickListener mOnClickListener = new C00642();
    View mProgressContainer;
    private final Runnable mRequestFocus = new C00631();
    ...
    class C00642 implements OnItemClickListener {
        C00642() {
        }
