...
public class NotificationCompat {
    ...
    public static class Action extends android.support.v4.app.NotificationCompatBase.Action {
        @RestrictTo({Scope.LIBRARY_GROUP})
        public static final android.support.v4.app.NotificationCompatBase.Action.Factory FACTORY = new C07671();
        ...
        static class C07671 implements android.support.v4.app.NotificationCompatBase.Action.Factory {
            C07671() {
            }
    ...
    public static final class CarExtender implements Extender {
        ...
        public static class UnreadConversation extends android.support.v4.app.NotificationCompatBase.UnreadConversation {
            static final Factory FACTORY = new C07681();
            ...
            static class C07681 implements Factory {
                C07681() {
                }
        ...
        public static final class Message {
            ...
            static Message getMessageFromBundle(Bundle bundle) {
                try {
                    ...
                    Message message = new Message(bundle.getCharSequence(KEY_TEXT), bundle.getLong(KEY_TIMESTAMP), bundle.getCharSequence("sender"));
