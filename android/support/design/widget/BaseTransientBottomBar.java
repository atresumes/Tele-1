...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
    ...
    static final Handler sHandler = new Handler(Looper.getMainLooper(), new C00081());
    private final AccessibilityManager mAccessibilityManager;
    private List<BaseCallback<B>> mCallbacks;
    private final ContentViewCallback mContentViewCallback;
    private final Context mContext;
    private int mDuration;
    final Callback mManagerCallback = new C07353();
    private final ViewGroup mTargetParent;
    final SnackbarBaseLayout mView;

    static class C00081 implements Callback {
        C00081() {
        }
    ...
    class C07342 implements OnApplyWindowInsetsListener {
        C07342() {
        }
    ...
    class C07353 implements Callback {
        C07353() {
        }
    ...
    class C07364 implements OnDismissListener {
        C07364() {
        }
    ...
    class C07375 implements OnAttachStateChangeListener {
        ...
        public void onViewDetachedFromWindow(View v) {
            if (BaseTransientBottomBar.this.isShownOrQueued()) {
                BaseTransientBottomBar.sHandler.post(new C00091());
            }
        }
    }

    class C07386 implements OnLayoutChangeListener {
        C07386() {
        }
    ...
    class C11167 extends ViewPropertyAnimatorListenerAdapter {
        C11167() {
        }
    ...
    protected BaseTransientBottomBar(@NonNull ViewGroup parent, @NonNull View content, @NonNull ContentViewCallback contentViewCallback) {
        if (parent == null) {
            ...
            ViewCompat.setOnApplyWindowInsetsListener(this.mView, new C07342());
    ...
    final void showView() {
        if (this.mView.getParent() == null) {
            ...
            if (lp instanceof CoordinatorLayout.LayoutParams) {
                ...
                behavior.setListener(new C07364());
                clp.setBehavior(behavior);
                clp.insetEdge = 80;
            }
            this.mTargetParent.addView(this.mView);
        }
        this.mView.setOnAttachStateChangeListener(new C07375());
        if (!ViewCompat.isLaidOut(this.mView)) {
            this.mView.setOnLayoutChangeListener(new C07386());
    ...
    void animateViewIn() {
        if (VERSION.SDK_INT >= 14) {
            ...
            ViewCompat.animate(this.mView).translationY(0.0f).setInterpolator(AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR).setDuration(250).setListener(new C11167()).start();
            return;
        }
