...
public class NavigationView extends ScrimInsetsFrameLayout {
    ...
    class C07531 implements Callback {
        C07531() {
        }
    ...
    public static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C07541());
        public Bundle menuState;

        static class C07541 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C07541() {
            }
    ...
    public NavigationView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mMenu.setCallback(new C07531());
    ...
    private ColorStateList createDefaultColorStateList(int baseColorThemeAttr) {
        ...
        if (!getContext().getTheme().resolveAttribute(C0175R.attr.colorPrimary, value, true)) {
            return null;
        }
