...
public class BottomSheetDialog extends AppCompatDialog {
    ...
    class C07432 extends AccessibilityDelegateCompat {
        C07432() {
        }
    ...
    public BottomSheetDialog(@NonNull Context context, @StyleRes int theme) {
        ...
        this.mBottomSheetCallback = new C07443();
    ...
    private View wrapInBottomSheet(int layoutResId, View view, LayoutParams params) {
        ...
        coordinator.findViewById(C0003R.id.touch_outside).setOnClickListener(new C00121());
        ViewCompat.setAccessibilityDelegate(bottomSheet, new C07432());
        return coordinator;
    }
