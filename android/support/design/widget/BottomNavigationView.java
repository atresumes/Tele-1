...
public class BottomNavigationView extends FrameLayout {
    ...
    class C07391 implements Callback {
        C07391() {
        }
    ...
    static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C07401());
        Bundle menuPresenterState;

        static class C07401 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C07401() {
            }
    ...
    public BottomNavigationView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mMenu.setCallback(new C07391());
    }
