...
public class AppBarLayout extends LinearLayout {
    ...
    class C07311 implements OnApplyWindowInsetsListener {
        C07311() {
        }
    ...
    public static class Behavior extends HeaderBehavior<AppBarLayout> {
        ...
        protected static class SavedState extends AbsSavedState {
            public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C07331());
            boolean firstVisibleChildAtMinimumHeight;
            int firstVisibleChildIndex;
            float firstVisibleChildPercentageShown;

            static class C07331 implements ParcelableCompatCreatorCallbacks<SavedState> {
                C07331() {
                }
    ...
    public AppBarLayout(Context context, AttributeSet attrs) {
        ...
        if (a.hasValue(C0003R.styleable.AppBarLayout_expanded)) {
            setExpanded(a.getBoolean(C0003R.styleable.AppBarLayout_expanded, false), false, false);
        }
        ...
        a.recycle();
        ViewCompat.setOnApplyWindowInsetsListener(this, new C07311());
    }
