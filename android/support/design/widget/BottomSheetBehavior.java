...
public class BottomSheetBehavior<V extends View> extends Behavior<V> {
    ...
    private final Callback mDragCallback = new C07412();
    boolean mHideable;
    ...
    protected static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C07421());
        final int state;

        static class C07421 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C07421() {
            }
