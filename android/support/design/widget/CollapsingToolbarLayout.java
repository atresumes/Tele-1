...
public class CollapsingToolbarLayout extends FrameLayout {
    ...
    class C07461 implements OnApplyWindowInsetsListener {
        C07461() {
        }
    ...
    class C07472 implements AnimatorUpdateListener {
        C07472() {
        }
    ...
    public CollapsingToolbarLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mCollapsingTextHelper.setCollapsedTextAppearance(C0175R.style.TextAppearance_AppCompat_Widget_ActionBar_Title);
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C07461());
    }
    ...
    private void animateScrim(int targetAlpha) {
        ...
        if (this.mScrimAnimator == null) {
            ...
            this.mScrimAnimator.addUpdateListener(new C07472());
