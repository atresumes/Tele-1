...
public class TabLayout extends HorizontalScrollView {
    ...
    class C07561 implements AnimatorUpdateListener {
        C07561() {
        }
    ...
    public TabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray ta = context.obtainStyledAttributes(this.mTabTextAppearance, C0175R.styleable.TextAppearance);
        try {
            this.mTabTextSize = (float) ta.getDimensionPixelSize(C0175R.styleable.TextAppearance_android_textSize, 0);
            this.mTabTextColors = ta.getColorStateList(C0175R.styleable.TextAppearance_android_textColor);
    ...
    private void ensureScrollAnimator() {
        if (this.mScrollAnimator == null) {
            ...
            this.mScrollAnimator.addUpdateListener(new C07561());
        }
    }
