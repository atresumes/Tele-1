...
public class BottomNavigationItemView extends FrameLayout implements ItemView {
    ...
    public BottomNavigationItemView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mScaleUpFactor = (((float) activeLabelSize) * DefaultRetryPolicy.DEFAULT_BACKOFF_MULT) / ((float) inactiveLabelSize);
        this.mScaleDownFactor = (((float) inactiveLabelSize) * DefaultRetryPolicy.DEFAULT_BACKOFF_MULT) / ((float) activeLabelSize);
    ...
    public void setChecked(boolean checked) {
        ...
        if (this.mShiftingMode) {
            if (checked) {
                ...
                ViewCompat.setScaleX(this.mLargeLabel, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT);
                ViewCompat.setScaleY(this.mLargeLabel, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT);
            } else {
                iconParams = (LayoutParams) this.mIcon.getLayoutParams();
            ...
            ViewCompat.setScaleX(this.mSmallLabel, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT);
            ViewCompat.setScaleY(this.mSmallLabel, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT);
        }
        refreshDrawableState();
    }
