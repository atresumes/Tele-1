...
public class ParcelableSparseArray extends SparseArray<Parcelable> implements Parcelable {
    public static final Creator<ParcelableSparseArray> CREATOR = ParcelableCompat.newCreator(new C07291());

    static class C07291 implements ParcelableCompatCreatorCallbacks<ParcelableSparseArray> {
        C07291() {
        }
