...
public class NavigationMenuItemView extends ForegroundLinearLayout implements ItemView {
    ...
    class C07281 extends AccessibilityDelegateCompat {
        C07281() {
        }
    ...
    public NavigationMenuItemView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mAccessibilityDelegate = new C07281();
        setOrientation(0);
    ...
    private StateListDrawable createDefaultBackground() {
        ...
        if (!getContext().getTheme().resolveAttribute(C0175R.attr.colorControlHighlight, value, true)) {
            return null;
        }
