...
class ChangeBoundsPort extends TransitionPort {
    ...
    class C11221 extends TransitionListenerAdapter {
    ...
    class C11232 extends TransitionListenerAdapter {
        boolean mCanceled = false;
            ...
            if (numChanges > 0) {
                ...
                if (this.mResizeClip) {
                    ...
                    if (view.getParent() instanceof ViewGroup) {
                        ...
                        addListener(new C11232());
                    }
                    anim.addListener(new C00323());
                    return anim;
                }
                pvh = new PropertyValuesHolder[numChanges];
                if (startLeft != endLeft) {
