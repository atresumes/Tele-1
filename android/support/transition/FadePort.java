...
class FadePort extends VisibilityPort {
    ...
    public Animator onAppear(ViewGroup sceneRoot, TransitionValues startValues, int startVisibility, TransitionValues endValues, int endVisibility) {
        ...
        addListener(new TransitionListenerAdapter() {
            ...
            public void onTransitionCancel(TransitionPort transition) {
                endView.setAlpha(DefaultRetryPolicy.DEFAULT_BACKOFF_MULT);
                this.mCanceled = true;
            }
        ...
        return createAnimation(endView, 0.0f, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT, null);
    }
    ...
    public Animator onDisappear(ViewGroup sceneRoot, TransitionValues startValues, int startVisibility, TransitionValues endValues, int endVisibility) {
        ...
        if (overlayView != null) {
            ...
            return createAnimation(view, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT, 0.0f, new AnimatorListenerAdapter() {
                public void onAnimationEnd(Animator animation) {
                    finalView.setAlpha(DefaultRetryPolicy.DEFAULT_BACKOFF_MULT);
