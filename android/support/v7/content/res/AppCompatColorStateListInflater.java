    ...
    private static ColorStateList inflate(@NonNull Resources r, @NonNull XmlPullParser parser, @NonNull AttributeSet attrs, @Nullable Theme theme) throws XmlPullParserException, IOException {
        ...
        while (true) {
            ...
            if (depth < innerDepth && type == 3) {
                ...
                TypedArray a = obtainAttributes(r, theme, attrs, C0175R.styleable.ColorStateListItem);
                int baseColor = a.getColor(C0175R.styleable.ColorStateListItem_android_color, -65281);
                float alphaMod = DefaultRetryPolicy.DEFAULT_BACKOFF_MULT;
                if (a.hasValue(C0175R.styleable.ColorStateListItem_android_alpha)) {
                    alphaMod = a.getFloat(C0175R.styleable.ColorStateListItem_android_alpha, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT);
                } else if (a.hasValue(C0175R.styleable.ColorStateListItem_alpha)) {
                    alphaMod = a.getFloat(C0175R.styleable.ColorStateListItem_alpha, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT);
                }
                a.recycle();
                ...
                while (i < numAttrs) {
                    ...
                    if (stateResId == 16843173 || stateResId == 16843551 || stateResId == C0175R.attr.alpha) {
                        j2 = j;
                    } else {
                        j2 = j + 1;
