...
class ToolbarActionBar extends ActionBar {
    ...
    private final OnMenuItemClickListener mMenuClicker = new C08102();
    private final Runnable mMenuInvalidator = new C01741();
    ...
    class C08102 implements OnMenuItemClickListener {
        C08102() {
        }
...
*/
    ...
    private void ensureListMenuPresenter(Menu menu) {
        if (this.mListMenuPresenter == null && (menu instanceof MenuBuilder)) {
            ...
            this.mListMenuPresenter = new ListMenuPresenter(context2, C0175R.layout.abc_list_menu_item_layout);
