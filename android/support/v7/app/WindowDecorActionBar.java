...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    final ViewPropertyAnimatorListener mHideListener = new C11311();
    ...
    final ViewPropertyAnimatorListener mShowListener = new C11322();
    private boolean mShowingForMode;
    ScrollingTabContainerView mTabScrollView;
    private ArrayList<TabImpl> mTabs = new ArrayList();
    private Context mThemedContext;
    final ViewPropertyAnimatorUpdateListener mUpdateListener = new C08113();

    class C08113 implements ViewPropertyAnimatorUpdateListener {
        C08113() {
        }
    ...
    class C11311 extends ViewPropertyAnimatorListenerAdapter {
        C11311() {
        }
    ...
    class C11322 extends ViewPropertyAnimatorListenerAdapter {
        C11322() {
        }
    ...
    private void init(View decor) {
        this.mOverlayLayout = (ActionBarOverlayLayout) decor.findViewById(C0175R.id.decor_content_parent);
        if (this.mOverlayLayout != null) {
            this.mOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(decor.findViewById(C0175R.id.action_bar));
        this.mContextView = (ActionBarContextView) decor.findViewById(C0175R.id.action_context_bar);
        this.mContainerView = (ActionBarContainer) decor.findViewById(C0175R.id.action_bar_container);
        ...
        TypedArray a = this.mContext.obtainStyledAttributes(null, C0175R.styleable.ActionBar, C0175R.attr.actionBarStyle, 0);
        if (a.getBoolean(C0175R.styleable.ActionBar_hideOnContentScroll, false)) {
            setHideOnContentScrollEnabled(true);
        }
        int elevation = a.getDimensionPixelSize(C0175R.styleable.ActionBar_elevation, 0);
        if (elevation != 0) {
    ...
    private DecorToolbar getDecorToolbar(View view) {
        ...
        throw new IllegalStateException(new StringBuilder().append("Can't make a decor toolbar out of ").append(view).toString() != null ? view.getClass().getSimpleName() : SdkConstants.NULL_STRING);
    }
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0175R.attr.actionBarWidgetTheme, outValue, true);
