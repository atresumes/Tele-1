...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild {
    ...
    static final Interpolator sQuinticInterpolator = new C02093();
    ...
    static class C02093 implements Interpolator {
        C02093() {
        }
    ...
    public static abstract class LayoutManager {
        ...
        private final Callback mHorizontalBoundCheckCallback = new C08331();
        ...
        private final Callback mVerticalBoundCheckCallback = new C08342();
        private int mWidth;
        ...
        class C08331 implements Callback {
            C08331() {
            }
        ...
        public static Properties getProperties(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
            ...
            properties.orientation = a.getInt(C0177R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = a.getInt(C0177R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = a.getBoolean(C0177R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = a.getBoolean(C0177R.styleable.RecyclerView_stackFromEnd, false);
            a.recycle();
            return properties;
        }
    ...
    class C08304 implements ProcessCallback {
        C08304() {
        }
    ...
    class C08315 implements Callback {
        C08315() {
        }
    ...
    class C08326 implements Callback {
        C08326() {
        }
    ...
    public static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C08351());
        Parcelable mLayoutState;

        static class C08351 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C08351() {
            }
    ...
    public RecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        this.mUpdateChildViewsRunnable = new C02071();
        ...
        this.mItemAnimatorRunner = new C02082();
        this.mViewInfoProcessCallback = new C08304();
        if (attrs != null) {
        ...
        if (attrs != null) {
            a = context.obtainStyledAttributes(attrs, C0177R.styleable.RecyclerView, defStyle, 0);
            String layoutManagerName = a.getString(C0177R.styleable.RecyclerView_layoutManager);
            if (a.getInt(C0177R.styleable.RecyclerView_android_descendantFocusability, -1) == -1) {
    ...
    private void initChildrenHelper() {
        this.mChildHelper = new ChildHelper(new C08315());
    }

    void initAdapterManager() {
        this.mAdapterHelper = new AdapterHelper(new C08326());
    }
