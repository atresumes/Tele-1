...
public class PopupMenu {
    ...
    class C02062 implements android.widget.PopupWindow.OnDismissListener {
        C02062() {
        }
    ...
    class C08281 implements Callback {
        C08281() {
        }
    ...
    public PopupMenu(@NonNull Context context, @NonNull View anchor, int gravity) {
        this(context, anchor, gravity, C0175R.attr.popupMenuStyle, 0);
    }
    ...
    public PopupMenu(@NonNull Context context, @NonNull View anchor, int gravity, @AttrRes int popupStyleAttr, @StyleRes int popupStyleRes) {
        ...
        this.mMenu.setCallback(new C08281());
        ...
        this.mPopup.setOnDismissListener(new C02062());
    }
