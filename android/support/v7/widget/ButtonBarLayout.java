...
public class ButtonBarLayout extends LinearLayout {
    ...
    public ButtonBarLayout(Context context, AttributeSet attrs) {
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, C0175R.styleable.ButtonBarLayout);
        this.mAllowStacking = ta.getBoolean(C0175R.styleable.ButtonBarLayout_allowStacking, allowStackingDefault);
        ta.recycle();
    }
    ...
    private void setStacked(boolean stacked) {
        ...
        View spacer = findViewById(C0175R.id.spacer);
        if (spacer != null) {
