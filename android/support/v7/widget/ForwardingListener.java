...
public abstract class ForwardingListener implements OnTouchListener {
    ...
    class C02001 implements OnAttachStateChangeListener {
        C02001() {
        }
    ...
    private void addDetachListenerApi12(View src) {
        src.addOnAttachStateChangeListener(new C02001());
    }

    private void addDetachListenerBase(View src) {
        src.getViewTreeObserver().addOnGlobalLayoutListener(new C02012());
    }
