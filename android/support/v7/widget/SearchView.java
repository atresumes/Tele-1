...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    class C02144 implements OnFocusChangeListener {
        C02144() {
        }
    ...
    class C02155 implements OnLayoutChangeListener {
        C02155() {
        }
    ...
    class C02166 implements OnGlobalLayoutListener {
        C02166() {
        }
    ...
    class C02177 implements OnClickListener {
        C02177() {
        }
    ...
    class C02188 implements OnKeyListener {
        C02188() {
        }
    ...
    class C02199 implements OnEditorActionListener {
        C02199() {
        }
    ...
    static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C08371());
        boolean isIconified;

        static class C08371 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C08371() {
            }
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        public SearchAutoComplete(Context context, AttributeSet attrs) {
            this(context, attrs, C0175R.attr.autoCompleteTextViewStyle);
        }
    ...
    public SearchView(Context context, AttributeSet attrs) {
        this(context, attrs, C0175R.attr.searchViewStyle);
    }
    ...
    public SearchView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mShowImeRunnable = new C02111();
        this.mUpdateDrawableStateRunnable = new C02122();
        this.mReleaseCursorRunnable = new C02133();
        this.mOutsideDrawablesCache = new WeakHashMap();
        this.mOnClickListener = new C02177();
        this.mTextKeyListener = new C02188();
        this.mOnEditorActionListener = new C02199();
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0175R.styleable.SearchView, defStyleAttr, 0);
        LayoutInflater.from(context).inflate(a.getResourceId(C0175R.styleable.SearchView_layout, C0175R.layout.abc_search_view), this, true);
        this.mSearchSrcTextView = (SearchAutoComplete) findViewById(C0175R.id.search_src_text);
        this.mSearchSrcTextView.setSearchView(this);
        this.mSearchEditFrame = findViewById(C0175R.id.search_edit_frame);
        this.mSearchPlate = findViewById(C0175R.id.search_plate);
        this.mSubmitArea = findViewById(C0175R.id.submit_area);
        this.mSearchButton = (ImageView) findViewById(C0175R.id.search_button);
        this.mGoButton = (ImageView) findViewById(C0175R.id.search_go_btn);
        this.mCloseButton = (ImageView) findViewById(C0175R.id.search_close_btn);
        this.mVoiceButton = (ImageView) findViewById(C0175R.id.search_voice_btn);
        this.mCollapsedIcon = (ImageView) findViewById(C0175R.id.search_mag_icon);
        ViewCompat.setBackground(this.mSearchPlate, a.getDrawable(C0175R.styleable.SearchView_queryBackground));
        ViewCompat.setBackground(this.mSubmitArea, a.getDrawable(C0175R.styleable.SearchView_submitBackground));
        this.mSearchButton.setImageDrawable(a.getDrawable(C0175R.styleable.SearchView_searchIcon));
        this.mGoButton.setImageDrawable(a.getDrawable(C0175R.styleable.SearchView_goIcon));
        this.mCloseButton.setImageDrawable(a.getDrawable(C0175R.styleable.SearchView_closeIcon));
        this.mVoiceButton.setImageDrawable(a.getDrawable(C0175R.styleable.SearchView_voiceIcon));
        this.mCollapsedIcon.setImageDrawable(a.getDrawable(C0175R.styleable.SearchView_searchIcon));
        this.mSearchHintIcon = a.getDrawable(C0175R.styleable.SearchView_searchHintIcon);
        this.mSuggestionRowLayout = a.getResourceId(C0175R.styleable.SearchView_suggestionRowLayout, C0175R.layout.abc_search_dropdown_item_icons_2line);
        this.mSuggestionCommitIconResId = a.getResourceId(C0175R.styleable.SearchView_commitIcon, 0);
        ...
        this.mSearchSrcTextView.setOnFocusChangeListener(new C02144());
        setIconifiedByDefault(a.getBoolean(C0175R.styleable.SearchView_iconifiedByDefault, true));
        int maxWidth = a.getDimensionPixelSize(C0175R.styleable.SearchView_android_maxWidth, -1);
        if (maxWidth != -1) {
            setMaxWidth(maxWidth);
        }
        this.mDefaultQueryHint = a.getText(C0175R.styleable.SearchView_defaultQueryHint);
        this.mQueryHint = a.getText(C0175R.styleable.SearchView_queryHint);
        int imeOptions = a.getInt(C0175R.styleable.SearchView_android_imeOptions, -1);
        if (imeOptions != -1) {
            setImeOptions(imeOptions);
        }
        int inputType = a.getInt(C0175R.styleable.SearchView_android_inputType, -1);
        if (inputType != -1) {
            setInputType(inputType);
        }
        setFocusable(a.getBoolean(C0175R.styleable.SearchView_android_focusable, true));
        a.recycle();
    ...
    private void addOnLayoutChangeListenerToDropDownAnchorSDK11() {
        this.mDropDownAnchor.addOnLayoutChangeListener(new C02155());
    }

    private void addOnLayoutChangeListenerToDropDownAnchorBase() {
        this.mDropDownAnchor.getViewTreeObserver().addOnGlobalLayoutListener(new C02166());
    }
    ...
    private int getPreferredHeight() {
        return getContext().getResources().getDimensionPixelSize(C0175R.dimen.abc_search_view_preferred_height);
    }
    ...
    void adjustDropDownSizeAndPosition() {
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            int iconOffset = this.mIconifiedByDefault ? res.getDimensionPixelSize(C0175R.dimen.abc_dropdownitem_icon_width) + res.getDimensionPixelSize(C0175R.dimen.abc_dropdownitem_text_padding_left) : 0;
