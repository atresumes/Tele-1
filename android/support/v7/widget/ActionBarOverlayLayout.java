...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    static final int[] ATTRS = new int[]{C0175R.attr.actionBarSize, 16842841};
    ...
    class C11341 extends ViewPropertyAnimatorListenerAdapter {
        C11341() {
        }
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attrs) {
        ...
        this.mTopAnimatorListener = new C11341();
        this.mRemoveActionBarHideOffset = new C01872();
        this.mAddActionBarHideOffset = new C01883();
        init(context);
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0175R.id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0175R.id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0175R.id.action_bar));
        }
    }
