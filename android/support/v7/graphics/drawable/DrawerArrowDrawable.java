...
public class DrawerArrowDrawable extends Drawable {
    ...
    public DrawerArrowDrawable(Context context) {
        ...
        TypedArray a = context.getTheme().obtainStyledAttributes(null, C0175R.styleable.DrawerArrowToggle, C0175R.attr.drawerArrowStyle, C0175R.style.Base_Widget_AppCompat_DrawerArrowToggle);
        setColor(a.getColor(C0175R.styleable.DrawerArrowToggle_color, 0));
        setBarThickness(a.getDimension(C0175R.styleable.DrawerArrowToggle_thickness, 0.0f));
        setSpinEnabled(a.getBoolean(C0175R.styleable.DrawerArrowToggle_spinBars, true));
        setGapSize((float) Math.round(a.getDimension(C0175R.styleable.DrawerArrowToggle_gapBetweenBars, 0.0f)));
        this.mSize = a.getDimensionPixelSize(C0175R.styleable.DrawerArrowToggle_drawableSize, 0);
        this.mBarLength = (float) Math.round(a.getDimension(C0175R.styleable.DrawerArrowToggle_barLength, 0.0f));
        this.mArrowHeadLength = (float) Math.round(a.getDimension(C0175R.styleable.DrawerArrowToggle_arrowHeadLength, 0.0f));
        this.mArrowShaftLength = a.getDimension(C0175R.styleable.DrawerArrowToggle_arrowShaftLength, 0.0f);
        a.recycle();
    }
    ...
    public void draw(Canvas canvas) {
        ...
        canvas.translate((float) bounds.centerX(), (float) (((double) ((float) ((((int) ((((float) bounds.height()) - (3.0f * barThickness)) - (this.mBarGap * ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT))) / 4) * 2))) + ((((double) barThickness) * 1.5d) + ((double) this.mBarGap))));
        if (this.mSpin) {
