...
public class CreditCard implements Parcelable {
    public static final Creator<CreditCard> CREATOR = new C06721();
    ...
    static class C06721 implements Creator<CreditCard> {
        C06721() {
        }
    ...
    public String getRedactedCardNumber() {
        ...
        if (this.cardNumber.length() > 4) {
            redacted = redacted + String.format("%" + (this.cardNumber.length() - 4) + "s", new Object[]{""}).replace(' ', '•');
        }
