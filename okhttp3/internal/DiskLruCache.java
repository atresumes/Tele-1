...
public final class DiskLruCache implements Closeable, Flushable {
    ...
    private static final Sink NULL_SINK = new C10914();
    private static final String READ = "READ";
    private static final String REMOVE = "REMOVE";
    static final String VERSION_1 = "1";
    private final int appVersion;
    private final Runnable cleanupRunnable = new C06881();
    ...
    class C06893 implements Iterator<Snapshot> {
    ...
    public final class Editor {
        ...
        public Sink newSink(int index) throws IOException {
            ...
            synchronized (DiskLruCache.this) {
                ...
                try {
                    c12011 = new FaultHidingSink(DiskLruCache.this.fileSystem.sink(this.entry.dirtyFiles[index])) {
    ...
    static class C10914 implements Sink {
        C10914() {
        }
    ...
    private boolean journalRebuildRequired() {
        return this.redundantOpCount >= InternalErrorCodes.CapabilityUserNotFound && this.redundantOpCount >= this.lruEntries.size();
    }
