...
public final class HttpEngine {
    private static final ResponseBody EMPTY_BODY = new C11041();
    ...
    static class C11041 extends ResponseBody {
        C11041() {
        }
...
*/
    ...
    private Request networkRequest(Request request) throws IOException {
        ...
        if (request.header(SdkConstants.USER_AGENT) == null) {
            result.header(SdkConstants.USER_AGENT, Version.userAgent());
        }
        return result.build();
    }
