...
public class SdkConstants {
    ...
    public static final Configuration CONFIGURATION_INFINITE = new Builder().setDuration(-1).build();
    public static final Configuration CONFIGURATION_LONG = new Builder().setDuration(5000).build();
    public static final Configuration CONFIGURATION_SHORT = new Builder().setDuration(3000).build();
