...
public class JsonReader implements Closeable {
    ...
    final class C09681 extends JsonReaderInternalAccess {
        C09681() {
        }
    ...
    static {
        JsonReaderInternalAccess.INSTANCE = new C09681();
    }
    ...
    private boolean isLiteral(char c) {
        switch (c) {
            ...
            case '[':
            case ']':
            case ConfirmScheduleActivity.PAYPAL_REQUEST_CODE /*123*/:
            case '}':
                break;
            case '#':
            case '/':
    ...
    private int peekKeyword() {
        ...
        if (c == 't' || c == 'T') {
            str = "true";
            str2 = SdkConstants.TRUE_STRING;
            i = 5;
        } else if (c == 'f' || c == 'F') {
            str = SdkConstants.FALSE_STRING;
            str2 = "FALSE";
            i = 6;
        } else if (c != 'n' && c != 'N') {
            return 0;
        } else {
            str = SdkConstants.NULL_STRING;
            str2 = "NULL";
            i = 7;
        }
