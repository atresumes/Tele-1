...
public final class LinkedTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    private static final Comparator<Comparable> NATURAL_ORDER = new C05611();
    ...
    final class C05611 implements Comparator<Comparable> {
        C05611() {
        }
    ...
    class EntrySet extends AbstractSet<Entry<K, V>> {
        ...
        class C09451 extends LinkedTreeMapIterator<Entry<K, V>> {
            C09451() {
                super();
            }
    ...
    final class KeySet extends AbstractSet<K> {
        ...
        class C09461 extends LinkedTreeMapIterator<K> {
            C09461() {
                super();
            }
