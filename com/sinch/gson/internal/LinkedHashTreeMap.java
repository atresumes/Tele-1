...
public final class LinkedHashTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    private static final Comparator<Comparable> NATURAL_ORDER = new C05601();
    ...
    final class C05601 implements Comparator<Comparable> {
        C05601() {
        }
    ...
    final class EntrySet extends AbstractSet<Entry<K, V>> {
        ...
        class C09431 extends LinkedTreeMapIterator<Entry<K, V>> {
            C09431() {
                super();
            }
    ...
    final class KeySet extends AbstractSet<K> {
        ...
        class C09441 extends LinkedTreeMapIterator<K> {
            C09441() {
                super();
            }
