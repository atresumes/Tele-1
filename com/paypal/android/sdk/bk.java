...
public final class bk extends SSLSocketFactory {
    private SSLSocketFactory f129a;
    ...
    public bk() {
        ...
        try {
            ...
            this.f129a = instance.getSocketFactory();
    ...
    public bk(InputStream inputStream) {
        try {
            ...
            this.f129a = instance3.getSocketFactory();
            try {
                inputStream.close();
            } catch (IOException e) {
    ...
    private static Socket m126a(Socket socket) {
    ...
    public final Socket createSocket(String str, int i) {
        return m126a(this.f129a.createSocket(str, i));
    }

    public final Socket createSocket(String str, int i, InetAddress inetAddress, int i2) {
        return m126a(this.f129a.createSocket(str, i, inetAddress, i2));
    }

    public final Socket createSocket(InetAddress inetAddress, int i) {
        return m126a(this.f129a.createSocket(inetAddress, i));
    }

    public final Socket createSocket(InetAddress inetAddress, int i, InetAddress inetAddress2, int i2) {
        return m126a(this.f129a.createSocket(inetAddress, i, inetAddress2, i2));
    }

    public final Socket createSocket(Socket socket, String str, int i, boolean z) {
        return m126a(this.f129a.createSocket(socket, str, i, z));
    }

    public final String[] getDefaultCipherSuites() {
        return this.f129a.getDefaultCipherSuites();
    }

    public final String[] getSupportedCipherSuites() {
        return this.f129a.getSupportedCipherSuites();
    }
}
