...
public class ProviderInstaller {
    ...
    class C03371 extends AsyncTask<Void, Void, Integer> {
        final /* synthetic */ ProviderInstallListener zzbEe;
        final /* synthetic */ Context zztf;

        C03371(Context context, ProviderInstallListener providerInstallListener) {
            this.zztf = context;
    ...
    public static void installIfNeededAsync(Context context, ProviderInstallListener providerInstallListener) {
        ...
        new C03371(context, providerInstallListener).execute(new Void[0]);
    }
