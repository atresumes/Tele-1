...
class zzatj extends zzauh {
    ...
    private boolean zza(String str, int i, com.google.android.gms.internal.zzauu.zzb com_google_android_gms_internal_zzauu_zzb) {
        ...
        try {
            ...
            contentValues.put(SdkConstants.DATA, bArr);
            try {
    ...
    public zzatg zzT(String str, String str2) {
        ...
        zzob();
        try {
            query = getWritableDatabase().query("conditional_properties", new String[]{Param.ORIGIN, "value", "active", "trigger_event_name", "trigger_timeout", "timed_out_event", "creation_timestamp", "triggered_event", "triggered_timestamp", "time_to_live", "expired_event"}, "app_id=? and name=?", new String[]{str, str2}, null, null, null);
            try {
                if (query.moveToFirst()) {
    ...
    Map<Integer, List<com.google.android.gms.internal.zzauu.zzb>> zzV(String str, String str2) {
        ...
        Cursor query;
        try {
            query = getWritableDatabase().query("event_filters", new String[]{"audience_id", SdkConstants.DATA}, "app_id=? AND event_name=?", new String[]{str, str2}, null, null, null);
            if (query.moveToFirst()) {
                do {
    ...
    Map<Integer, List<zzauu.zze>> zzW(String str, String str2) {
        ...
        Cursor query;
        try {
            query = getWritableDatabase().query("property_filters", new String[]{"audience_id", SdkConstants.DATA}, "app_id=? AND property_name=?", new String[]{str, str2}, null, null, null);
            if (query.moveToFirst()) {
                do {
                    zzbxl zzaf = zzbxl.zzaf(query.getBlob(1));
        ...
        try {
            ...
            if (cursor2.moveToFirst()) {
                ...
                try {
                    ...
                    cursor = writableDatabase.query("raw_events", new String[]{"rowid", "name", SdkConstants.LAST_USED_SESSION_TIMESTAMP, SdkConstants.DATA}, str4, strArr2, null, null, "rowid", null);
                    if (cursor.moveToFirst()) {
                        do {
                            try {
    ...
    public boolean zza(zzatg com_google_android_gms_internal_zzatg) {
        ...
        contentValues.put(Param.ORIGIN, com_google_android_gms_internal_zzatg.zzbqV);
        contentValues.put("name", com_google_android_gms_internal_zzatg.zzbqW.name);
        zza(contentValues, "value", com_google_android_gms_internal_zzatg.zzbqW.getValue());
    ...
    public boolean zza(zzatm com_google_android_gms_internal_zzatm, long j, boolean z) {
        ...
        try {
            ...
            contentValues.put(SdkConstants.LAST_USED_SESSION_TIMESTAMP, Long.valueOf(com_google_android_gms_internal_zzatm.zzaxb));
    ...
    public boolean zza(zzaus com_google_android_gms_internal_zzaus) {
        ...
        zza(contentValues, "value", com_google_android_gms_internal_zzaus.mValue);
        try {
    ...
    public List<zzatg> zzc(String str, String[] strArr) {
        ...
        Cursor query;
        try {
            String[] strArr2 = new String[]{"app_id", Param.ORIGIN, "name", "value", "active", "trigger_event_name", "trigger_timeout", "timed_out_event", "creation_timestamp", "triggered_event", "triggered_timestamp", "time_to_live", "expired_event"};
            zzKn().zzKZ();
    ...
    public List<zzaus> zzft(String str) {
        ...
        try {
            Cursor query = getWritableDatabase().query("user_attributes", new String[]{"name", Param.ORIGIN, "set_timestamp", "value"}, "app_id=?", new String[]{str}, null, null, "rowid", String.valueOf(zzKn().zzKX()));
            try {
                if (query.moveToFirst()) {
                    do {
                        String string = query.getString(0);
            ...
            if (query.moveToFirst()) {
                ...
                do {
                    ...
                    try {
                        ...
                        zzKl().zzLY().zzd("Failed to merge filter results. appId, audienceId, error", zzatx.zzfE(str), Integer.valueOf(i), e3);
                    }
                } while (query.moveToNext());
                if (query == null) {
                    return arrayMap;
    ...
    public List<zzaus> zzk(String str, String str2, String str3) {
        ...
        try {
            ...
            if (!TextUtils.isEmpty(str3)) {
                arrayList2.add(String.valueOf(str3).concat(CBConstant.DEFAULT_PAYMENT_URLS));
                stringBuilder.append(" and name glob ?");
            }
            String[] strArr = (String[]) arrayList2.toArray(new String[arrayList2.size()]);
            String[] strArr2 = new String[]{"name", "set_timestamp", "value", Param.ORIGIN};
            zzKn().zzKX();
                ...
                if (query.moveToFirst()) {
                    while (arrayList.size() < zzKn().zzKX()) {
                        ...
                        try {
                            ...
                            if (zzb == null) {
                                zzKl().zzLY().zzd("(2)Read invalid user property value, ignoring it", zzatx.zzfE(str), string, str3);
                            } else {
    ...
    public List<zzatg> zzl(String str, String str2, String str3) {
        ...
        if (!TextUtils.isEmpty(str3)) {
            arrayList.add(String.valueOf(str3).concat(CBConstant.DEFAULT_PAYMENT_URLS));
            stringBuilder.append(" and name glob ?");
        }
    ...
    public List<Pair<zze, Long>> zzn(String str, int i, int i2) {
        ...
        zzac.zzdr(str);
        try {
            query = getWritableDatabase().query("queue", new String[]{"rowid", SdkConstants.DATA}, "app_id=?", new String[]{str}, null, null, "rowid", String.valueOf(i));
            try {
                if (query.moveToFirst()) {
