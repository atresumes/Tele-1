...
public enum zzai {
    ...
    EVENT_VALUE(CBAnalyticsConstant.VALUE),
    ...
    PAGE("page"),
    PAGE_PATH("page_path"),
    PARAMS(SdkConstants.PARAMS),
    PARTITION("partition"),
    PERCENTAGE("percentage"),
    PIXEL("pixel"),
    PLACEMENT("placement"),
    PLATFORM(SdkConstants.CALLING_PLATFORM_NAME),
    POSITION("position"),
    PRICES("prices"),
    PRIORITY("priority"),
    PRODUCT("product"),
    ...
    TITLE(SdkConstants.BANK_TITLE_STRING),
