...
public class zzati extends zzaug {
    ...
    public String zzP(String str, String str2) {
        ...
        encodedAuthority.path(valueOf.length() != 0 ? str3.concat(valueOf) : new String(str3)).appendQueryParameter("app_instance_id", str2).appendQueryParameter(SdkConstants.CALLING_PLATFORM_NAME, "android").appendQueryParameter("gmp_version", String.valueOf(10298));
    ...
    int zzfo(String str) {
        return Math.max(0, Math.min(InternalErrorCodes.CapabilityUserNotFound, zzb(str, zzats.zzbst)));
    }
