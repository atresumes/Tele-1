...
import com.google.android.gms.C0268R;
...
public class zzg {
    ...
    public static int isGooglePlayServicesAvailable(Context context) {
        ...
        try {
            context.getResources().getString(C0268R.string.common_google_play_services_unknown_issue);
        } catch (Throwable th) {
    ...
    public static boolean zzaK(Context context) {
        if (zzt.zzzk()) {
            Bundle applicationRestrictions = ((UserManager) context.getSystemService(SdkConstants.USER)).getApplicationRestrictions(context.getPackageName());
