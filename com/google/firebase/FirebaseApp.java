...
public class FirebaseApp {
    ...
    class C08781 implements com.google.android.gms.internal.zzaac.zza {
        C08781() {
        }
    ...
    private <T> void zza(Class<T> cls, T t, Iterable<String> iterable) {
        ...
        for (String valueOf2 : iterable) {
            if (isDeviceProtectedStorage) {
                try {
                    if (!zzbWD.contains(valueOf2)) {
                    }
                } catch (ClassNotFoundException e) {
                    if (zzbWE.contains(valueOf2)) {
    ...
    public String toString() {
        return zzaa.zzv(this).zzg("name", this.mName).zzg(SdkConstants.OPTIONS, this.zzbWF).toString();
    }
