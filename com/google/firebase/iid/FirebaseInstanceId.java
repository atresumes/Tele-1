...
public class FirebaseInstanceId {
    ...
    public void deleteInstanceId() throws IOException {
        this.zzclj.zzb(CBConstant.DEFAULT_PAYMENT_URLS, CBConstant.DEFAULT_PAYMENT_URLS, null);
        this.zzclj.zzHi();
    }
    ...
    @Nullable
    zza zzabN() {
        return this.zzclj.zzabQ().zzu("", this.zzclk, CBConstant.DEFAULT_PAYMENT_URLS);
    }

    String zzabO() throws IOException {
        return getToken(this.zzclk, CBConstant.DEFAULT_PAYMENT_URLS);
    }
