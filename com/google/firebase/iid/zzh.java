    ...
    static class zza {
        ...
        static String zzd(String str, String str2, long j) {
            try {
                ...
                jSONObject.put(SdkConstants.TOKEN, str);
                jSONObject.put(SdkConstants.APP_VERSION, str2);
                jSONObject.put(SdkConstants.LAST_USED_SESSION_TIMESTAMP, j);
        ...
        static zza zzjA(String str) {
            ...
            try {
                ...
                return new zza(jSONObject.getString(SdkConstants.TOKEN), jSONObject.getString(SdkConstants.APP_VERSION), jSONObject.getLong(SdkConstants.LAST_USED_SESSION_TIMESTAMP));
            } catch (JSONException e) {
                String valueOf = String.valueOf(e);
