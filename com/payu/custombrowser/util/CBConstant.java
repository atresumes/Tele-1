...
public interface CBConstant {
    ...
    public static final int SNOOZE_DEFAULT_URL_LOAD_PERCENTAGE = 20;
    public static final int SNOOZE_DEFAULT_URL_LOAD_TIME_OUT = 5000;
    public static final String SNOOZE_ENABLED = "snoozeEnabled";
    public static final String[] SNOOZE_IMAGE_COLLECTIONS = new String[]{"coffie_128.jpg", "dogs_128.jpg", "pasta_128.jpg"};
