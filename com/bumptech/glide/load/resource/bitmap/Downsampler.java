...
public abstract class Downsampler implements BitmapDecoder<InputStream> {
    public static final Downsampler AT_LEAST = new C11461();
    public static final Downsampler AT_MOST = new C11472();
    private static final int MARK_POSITION = 5242880;
    public static final Downsampler NONE = new C11483();
    ...
    static class C11461 extends Downsampler {
        C11461() {
        }
    ...
    static class C11472 extends Downsampler {
        C11472() {
        }
    ...
    static class C11483 extends Downsampler {
        C11483() {
        }
