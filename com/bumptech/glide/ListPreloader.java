...
public class ListPreloader<T> implements OnScrollListener {
    ...
    class C08481 implements PreloadModelProvider<T> {
        C08481() {
        }
    ...
    class C08492 implements PreloadSizeProvider<T> {
        C08492() {
        }
    ...
    public ListPreloader(int maxPreload) {
        ...
        this.preloadModelProvider = new C08481();
        this.preloadDimensionProvider = new C08492();
