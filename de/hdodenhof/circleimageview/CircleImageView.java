...
public class CircleImageView extends ImageView {
    ...
    public CircleImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.mBorderWidth = 0;
        this.mFillColor = 0;
        TypedArray a = context.obtainStyledAttributes(attrs, C0663R.styleable.CircleImageView, defStyle, 0);
        this.mBorderWidth = a.getDimensionPixelSize(C0663R.styleable.CircleImageView_civ_border_width, 0);
        this.mBorderColor = a.getColor(C0663R.styleable.CircleImageView_civ_border_color, -16777216);
        this.mBorderOverlay = a.getBoolean(C0663R.styleable.CircleImageView_civ_border_overlay, false);
        this.mFillColor = a.getColor(C0663R.styleable.CircleImageView_civ_fill_color, 0);
        a.recycle();
        init();
    }
